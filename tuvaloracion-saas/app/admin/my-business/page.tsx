              ...
              <div key={business._id} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex flex-col lg:flex-row">
                  ...
                  <div className="flex-1 flex flex-col md:flex-row">
                    {/* Business Image - Se adapta al contenedor */}
                    <div className="w-full md:w-64 h-full relative flex-shrink-0 overflow-hidden">
                  ...
                  <div className="lg:w-80 p-3 lg:p-4 bg-gradient-to-br from-gray-50 to-white border-l border-gray-100 flex flex-col justify-center">
                    <BusinessQR
